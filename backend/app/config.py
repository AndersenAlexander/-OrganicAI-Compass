...
class Settings(BaseSettings):
    ...
    frontend_public_url: str = "http://127.0.0.1:5190"
    allowed_origins: str = "http://127.0.0.1:5190,http://localhost:5190"
    ...
    email_reply_to: str = ""
    email_public_base_url: str = "http://127.0.0.1:5190"
    smtp_host: str = ""
    smtp_port: int = 587
    smtp_username: str = ""
    ...
    frontend_url: str = "http://127.0.0.1:5190"
