...
async def get_market_radar(
    ...
    return market_radar(db, profile, _filters(provider, query, country, municipality, work_mode, career_family, active_only, limit))
...
async def get_market_jobs(
    ...
    profile = require_profile(db, profile_id, user)
    return list_jobs(db, profile, _filters(provider, query, country, municipality, work_mode, career_family, active_only, limit))
