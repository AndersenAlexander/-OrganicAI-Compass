...
class RagRun(Base):
    ...
    status:Mapped[str]=mapped_column(String(32),default="completed");error_code:Mapped[str|None]=mapped_column(String(80),nullable=True);error_message_safe:Mapped[str|None]=mapped_column(String(300),nullable=True);created_at:Mapped[datetime]=mapped_column(DateTime,default=utc_now_naive,index=True)
...
class RagFeedback(Base):
    ...
    created_at:Mapped[datetime]=mapped_column(DateTime,default=utc_now_naive);updated_at:Mapped[datetime]=mapped_column(DateTime,default=utc_now_naive,onupdate=utc_now_naive);run=relationship("RagRun",back_populates="feedback")
