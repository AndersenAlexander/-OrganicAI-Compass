...
class Interview(Base):
    ...
    requirement_set_version: Mapped[str] = mapped_column(String(120), default="unlinked")
    ...
    version_metadata_json: Mapped[dict] = mapped_column(JSON, default=dict)
    outcome_source: Mapped[str] = mapped_column(String(120), default="")
...
class InterviewQuestion(Base):
    ...
    question_type: Mapped[str] = mapped_column(String(80), default="experience", index=True)
    question_status: Mapped[str] = mapped_column(String(40), default="active", index=True)
    user_edited: Mapped[bool] = mapped_column(Boolean, default=False)
    custom: Mapped[bool] = mapped_column(Boolean, default=False)
    related_evidence_gap_json: Mapped[dict] = mapped_column(JSON, default=dict)
...
class StarStory(Base):
    ...
    linked_capability: Mapped[str] = mapped_column(String(160), default="")
    canonical_story_id: Mapped[str | None] = mapped_column(String, nullable=True, index=True)
    adaptation_context_json: Mapped[dict] = mapped_column(JSON, default=dict)
...
class MockInterviewSession(Base):
    ...
    panel_personas_json: Mapped[list] = mapped_column(JSON, default=list)
    persona_feedback_json: Mapped[dict] = mapped_column(JSON, default=dict)
    text_fallback_available: Mapped[bool] = mapped_column(Boolean, default=True)
    source: Mapped[str] = mapped_column(String(80), default="deterministic")
    demo_marker: Mapped[bool] = mapped_column(Boolean, default=False, index=True)
...
class MockInterviewTurn(Base):
    ...
    transcript_source: Mapped[str] = mapped_column(String(40), default="text")
    transcript_storage_status: Mapped[str] = mapped_column(String(40), default="not_stored")
    user_edited_transcript: Mapped[bool] = mapped_column(Boolean, default=False)
...
class VoiceProviderSession(Base):
    ...
    user_edited_transcript: Mapped[str] = mapped_column(Text, default="")
    transcript_storage_status: Mapped[str] = mapped_column(String(40), default="not_stored")
...
class InterviewReflection(Base):
    ...
    user_observation: Mapped[str] = mapped_column(Text, default="")
    ...
    system_suggestion_json: Mapped[list] = mapped_column(JSON, default=list)
...
class OfferReview(Base):
    ...
    demo_marker: Mapped[bool] = mapped_column(Boolean, default=False, index=True)
    version_number: Mapped[int] = mapped_column(Integer, default=1)
    comparison_snapshot_json: Mapped[dict] = mapped_column(JSON, default=dict)
    created_at: Mapped[datetime] = mapped_column(DateTime, default=utc_now_naive)
    updated_at: Mapped[datetime] = mapped_column(DateTime, default=utc_now_naive, onupdate=utc_now_naive)
