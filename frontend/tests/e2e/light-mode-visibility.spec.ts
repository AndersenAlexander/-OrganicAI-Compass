...
async function firstVisibleChild(locator: Locator, selector: string) {
  ...
  if (options.checkCards !== false) {
    const card = await firstVisibleLocator(
      ...
      [
        ...
        "main .principle-card",
        "main .responsible-boundaries-section article",
        "main .research-card",
        "main .research-question",
        "main .research-mini-card",
        "main .research-method-flow article",
        "main .research-evidence-grid > article",
    ...
    await expectReadable(await firstVisibleChild(card, "h2, h3, p, b, span"), 3);
  }
