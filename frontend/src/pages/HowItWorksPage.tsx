  ...
  const stages = useMemo<JourneyStage[]>(
    () => [
      ...
      },
      {
        ...
        description:
          "The text Coach retrieves relevant knowledge before generating an answer. Live voice uses the same approved static knowledge through Custom LLM retrieval or native-Agent synchronization.",
        cardDescription: "Ask through text or voice with grounded platform knowledge and clear provider boundaries.",
