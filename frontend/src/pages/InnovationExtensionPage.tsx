...
function recordSummary(items: unknown[]) {
                ...
                <article className="innovation-row" key={entry.id}>
                  <div>
                    ...
                    <details className="mt-3 text-sm">
                      <summary className="cursor-pointer font-semibold">Separate decision record</summary>
                      <div className="mt-3 grid gap-3 md:grid-cols-2">
                        <div><b>User decision</b><p>{entry.user_reasoning || entry.decision_summary}</p></div>
                        <div><b>Evidence</b><p>{recordSummary([...entry.evidence_links, ...entry.evidence_observations])}</p></div>
                        <div><b>AI suggestions</b><p>{recordSummary(entry.ai_explanations)}</p></div>
                        <div><b>System suggestions and calculations</b><p>{recordSummary(entry.system_suggestions)}</p></div>
                      </div>
                    </details>
                  </div>
