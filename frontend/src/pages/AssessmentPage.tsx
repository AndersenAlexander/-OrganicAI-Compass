...
import type { AssessmentDefinition, AssessmentItemDefinition, AssessmentMode, AssessmentSession } from "../types/assessment";
import { useAppActions } from "../hooks/useAppActions";

type ResponseMap = Record<string, unknown>;

const fallbackProfileId = "demo-profile";
...
export function AssessmentPage() {
  ...
  const profileId = params.profileId || activeProfileId || fallbackProfileId;
  ...
  useEffect(() => {
    ...
    getCurrentAssessmentSession(profileId)
      ...
      .catch(() => setError("The assessment module could not be loaded."))
      ...
      <div className="organic-page">
        <section className="organic-section">
          ...
          <p className="mt-4 max-w-3xl text-lg leading-8 theme-muted">
            The module supports personality tendencies, work style, interests, values, skills, AI readiness, constraints, and realistic career directions.
          </p>
