...
export function KnowledgeBasePage() {
  ...
  const [selected, setSelected] = useState("AI Literacy");
    ...
    <div className="kb-page">
      ...
      <header className="kb-hero">
        <div>
          ...
          <span>
            Search and ask questions grounded in eight curated documents. Sources, sections, snippets, and semantic
            retrieval scores stay visible.
          </span>
        </div>
        <div className="kb-metrics">
          <OrganicMetricCard value="8" label="Curated documents" />
          <OrganicMetricCard value="24" label="Indexed chunks" />
          <OrganicMetricCard value="4" label="Core research domains" />
