...
export function DiagnosticWizard() {
  ...
  const valid = [
    form.interests.length > 0 && form.natural_activities.length > 0 && form.preferred_orientation.length > 0,
    ...
    form.skills.length > 0 && form.preferred_learning_style.length > 0 && form.cognitive_style.length > 0,
  ...
  function saveExit() {
    ...
    navigate(localStorage.getItem("organicai.auth.token") ? "/my-journey" : "/");
  }
      ...
      <div className="glass-card relative overflow-hidden p-6">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {step === 3 && (
              <>
                <ChoiceGroup legend="Which skills do you already use confidently? *" options={optionSets.skills} selected={form.skills} onToggle={(value) => toggle("skills", value)} />
