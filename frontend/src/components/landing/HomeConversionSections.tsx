...
export function PlatformIntroduction() {
  return (
    <section
      id="what-is-organicai"
      className="home-platform-intro home-conversion-section"
      data-compass-anchor="left"
      data-testid="home-platform-intro"
    >
      <div>
...
export function ProductOverviewVideo() {
  ...
  return (
    <section
      id="overview-video"
      className="home-overview-video home-conversion-section"
      data-compass-anchor="right"
      data-testid="home-overview-video"
    >
      <SectionHeading
...
export function PlatformJourney({ activeProfileId }: { activeProfileId: string }) {
  return (
    <section
      id="how-it-works"
      className="home-product-journey home-conversion-section"
      data-compass-anchor="left"
      data-testid="home-product-journey"
    >
      <SectionHeading
...
export function ServicesOverview({ activeProfileId }: { activeProfileId: string }) {
  return (
    <section
      id="services"
      className="home-services home-conversion-section"
      data-compass-anchor="right"
...
export function VoiceCoachShowcase({ activeProfileId, onOpenCoach }: HomeConversionSectionsProps) {
  ...
  return (
    <section
      id="voice"
      className="home-voice home-conversion-section"
      data-compass-anchor="left"
...
export function BenefitsSection() {
  return (
    <section
      id="benefits"
      className="home-benefits home-conversion-section"
      data-compass-anchor="right"
...
export function TestimonialsSection() {
  return (
    <section
      id="testimonials"
      className="home-testimonials home-conversion-section"
      data-compass-anchor="left"
...
export function ResearchTrustSection() {
  return (
    <section
      id="research"
      className="home-trust home-conversion-section"
      data-compass-anchor="right"
...
export function InsightsSection() {
  ...
  return (
    <section
      id="insights"
      className="home-insights home-conversion-section"
      data-compass-anchor="left"
...
export function FinalConversionSection({ onOpenCoach }: HomeConversionSectionsProps) {
  return (
    <section
      className="home-final-conversion home-conversion-section"
