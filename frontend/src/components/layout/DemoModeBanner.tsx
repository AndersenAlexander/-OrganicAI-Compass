...
export function DemoModeBanner() {
  ...
  return <>
    <aside aria-label="Demo Mode" className="relative mx-auto mt-3 flex max-w-[1320px] flex-wrap items-center justify-between gap-3 rounded-2xl border border-[color:var(--oa-border-strong)] bg-[color:var(--oa-surface-strong)] px-4 py-3 text-[color:var(--oa-text)] shadow-[var(--oa-glow)]">
      ...
      <div className="flex gap-2"><button type="button" onClick={openDialog} className="inline-flex min-h-11 items-center gap-2 rounded-full border border-[color:var(--oa-border-strong)] px-4 text-sm font-bold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color:var(--color-accent-action)]"><RotateCcw size={15}/>Reset Demo</button><button type="button" onClick={() => void exitDemo()} className="inline-flex min-h-11 items-center gap-2 rounded-full px-4 text-sm font-bold text-[color:var(--oa-text-secondary)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color:var(--color-accent-action)]"><LogOut size={15}/>Exit Demo</button></div>
    </aside>
