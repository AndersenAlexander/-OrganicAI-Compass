...
async function submit(action: "save" | "save_and_analyse") {
  ...
  setStatus(result.status === "Duplicate" ? "Duplicate capture found in OrganicAI Compass." : "Capture saved for user review. Job Analysis is not created until confirmation.");
}
